...
"""
formats the 20140604_WI Midwest_Final csv file for upload
"""

def removeNonAscii(s): return "".join(filter(lambda x: ord(x)<128, s))

with open('../databases/20140604_WI Midwest_Final.csv', 'rbU') as csv_input:
    with open('../ready_to_upload/20140604_WI_Midwest_Final.csv', 'wb') as csv_output:
